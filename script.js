...
form.addEventListener('submit', function(e){
    ...
    .then((data) => {
        ...
        if(data.followers == 0){
            ...
            var your_followers = "<img src='https://github.com/JehanKandy/GITHUB-UserProfile/blob/master/images/bronze%20followers.png?raw=true' class='achie-nimg'><img src='https://github.com/JehanKandy/GITHUB-UserProfile-v0.3.2/blob/master/images/silver_followers.png?raw=true' class='achie-img'><img src='https://github.com/JehanKandy/GITHUB-UserProfile/blob/master/images/gold%20followers.png?raw=true' class='achie-img'>";
        }
